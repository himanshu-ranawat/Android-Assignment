...
import com.example.assignment.databinding.FeedsFragmentBinding
...
class FeedsActivityBinder() : AbstractBinding<FeedsFragmentBinding>(),
    ...
    /**
     * Decide to whether show/hide `SwipeRefreshLayout` based on [show] flag
     *
